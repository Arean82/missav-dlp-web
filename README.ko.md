...
- **모듈형 프록시**: 메타데이터 및 크롤링에 SpoofDPI 우회를 적용할 수 있는 글로벌 토글 추가.
- **산업용 런처**: 테마 지원(라이트/다크) 및 윈도우 작업표시줄 아이콘 연동이 포함된 새로운 CustomTkinter UI.
- **안정성**: 고아 SpoofDPI 인스턴스 방지를 위한 프로세스 생명주기 최적화.
